...
ARG NEXT_PUBLIC_CDN_ORIGIN=
ARG NEXT_PUBLIC_SOURCE_ASSET_ORIGIN=
...
ENV NEXT_PUBLIC_CDN_ORIGIN=${NEXT_PUBLIC_CDN_ORIGIN}
ENV NEXT_PUBLIC_SOURCE_ASSET_ORIGIN=${NEXT_PUBLIC_SOURCE_ASSET_ORIGIN}
